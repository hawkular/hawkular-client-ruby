...
describe 'Counter metrics' do
  ...
  it 'Should create counter definition using MetricDefinition parameter' do
    id = SecureRandom.uuid
    VCR.use_cassette('Counter_metrics/Should create counter definition using MetricDefinition parameter',
                     :erb => { :id => id}, record: :none
    ) do
...
describe 'Availability metrics' do
  ...
  it 'Should create and return Availability using Hash parameter' do
    id = SecureRandom.uuid
    VCR.use_cassette('Availability_metrics/Should create and return Availability using Hash parameter',
                     :erb => { :id => id}, record: :none
    ) do
  ...
  it 'Should create Availability definition using MetricDefinition parameter' do
    id = SecureRandom.uuid
    VCR.use_cassette('Availability_metrics/Should create Availability definition using MetricDefinition parameter',
                     :erb => { :id => id}, record: :none
    ) do
