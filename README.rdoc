...
== Developer-local gems

It is now possible to have a local gemfile `Gemfile.dev.rb` that is pulled in from the
main `Gemfile` to use e.g. debuggers or rubocop-git.
